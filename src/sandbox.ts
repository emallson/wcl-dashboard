...
window.addEventListener('message', event => {
    const worker_frame = document.getElementById('worker-frame') as HTMLIFrameElement;
...
export function runScript(guid: Guid, script: string, data: any, spec: any, callback: ScriptResult) {
